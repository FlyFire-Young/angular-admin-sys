...
(function () {
  ...
  CKEDITOR.event || (CKEDITOR.event = function () {
    ...
    return {
      define: function (b, d) {
        ...
        function m(e, a, z, y) {
          e = {name: b, sender: this, editor: e, data: a, listenerData: k, stop: z, cancel: y, removeListener: r};
        ...
        if (0 > e.getListenerIndex(d)) {
          ...
          m.fn = d;
          m.priority = g;
          for (var y = e.length - 1; 0 <= y; y--) if (e[y].priority <= g) return e.splice(y + 1, 0, m), {removeListener: r};
          e.unshift(m)
        }
      ...
      once: function () {
        ...
        return function (g, m, r) {
          ...
          if (e) {
            var y = e.listeners;
            if (y.length) for (var y = y.slice(0), A, D = 0; D < y.length; D++) {
              if (e.errorProof) try {
                A =
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
      ...
      is: function () {
        ...
        if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
          ...
          for (var b = [], d = 0; d < c.length; d++) if (e) for (var y =
            0; y < e.length; y++) b.push([a, c[d], e[y]].join("-")); else b.push([a, c[d]].join("-"));
        ...
        var b = 0, c = 0, e = this.getDocument(), d = e.getBody(), y = "BackCompat" == e.$.compatMode;
        if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
            8 !== CKEDITOR.env.version : 1)) {
          var f = this.$.getBoundingClientRect(), h = e.$.documentElement, x = h.clientTop || d.$.clientTop || 0,
        ...
        } else for (x = this, p = null; x && "body" != x.getName() &&
        "html" != x.getName();) {
        ...
        y = a.getWindow();
        d = x(this, y);
        var u = x(a, y), K = this.$.offsetHeight;
        e = this.$.offsetWidth;
      ...
      getFrameDocument: function () {
        ...
        for (var e = 0; e < c.length; e++) {
          var d = c[e], y = d.nodeName.toLowerCase(), f;
          if (!(y in b)) if ("checked" == y && (f = this.getAttribute(y))) a.setAttribute(y, f); else if (!CKEDITOR.env.ie || this.hasAttribute(y)) f = this.getAttribute(y), null === f && (f = d.nodeValue), a.setAttribute(y, f)
        }
        "" !== this.$.style.cssText &&
  ...
  (function () {
    function a(a, b) {
      ...
      e = c.endContainer;
      var f = c.startOffset, z = c.endOffset, h, l = this.guard, q = this.type,
  ...
  (function () {
    ...
    function d(a, b, c, d, f) {
      ...
      var q = a.startContainer, F = a.endContainer,
        L = a.startOffset, C = a.endOffset, M, t, E, w, H, P;
      if (l && F.type == CKEDITOR.NODE_TEXT && (q.equals(F) || q.type === CKEDITOR.NODE_ELEMENT && q.getFirst().equals(F))) c.append(a.document.createText(F.substring(L, C))); else {
        ...
        G = c;
        for (Q = N; Q <= B; Q++) if (c = n[Q], V = c.getPrevious(), c.equals(O[Q])) b && (G = G.getChild(0)); else {
      ...
      trim: function (a, b) {
        ...
        switch (a) {
          ...
          case CKEDITOR.ENLARGE_ELEMENT:
            ...
            var p = this.getCommonAncestor(), g = this.root, k, r, l, q, F, L = !1, C, M;
            ...
            for (l = c(l); l || q;) {
              ...
              for (; q;) if (C = !1, q.type == CKEDITOR.NODE_COMMENT) q = q.getPrevious(); else {
                if (q.type == CKEDITOR.NODE_TEXT) M = q.getText(), d.test(M) && (q = null), C = /[\s\ufeff]$/.test(M); else if ((q.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && q.is("br")) && !q.data("cke-bookmark")) if (L && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                  M =
                    q.getText();
                  if (d.test(M)) q = null; else for (var t = q.$.getElementsByTagName("*"), E = 0, w; w = t[E++];) if (!CKEDITOR.dtd.$removeEmpty[w.nodeName.toLowerCase()]) {
                    q = null;
                    break
                  }
                  q && (C = !!M.length)
            ...
            for (; l || q;) {
              ...
              for (; q;) {
                C = !1;
                if (q.type == CKEDITOR.NODE_TEXT) M = q.getText(), h(q, 0) || (q = null), C = /^[\s\ufeff]/.test(M); else if (q.type == CKEDITOR.NODE_ELEMENT) {
                  if ((0 < q.$.offsetWidth || b && q.is("br")) && !q.data("cke-bookmark")) if (L && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                    M =
                      q.getText();
                    if (d.test(M)) q = null; else for (t = q.$.getElementsByTagName("*"), E = 0; w = t[E++];) if (!CKEDITOR.dtd.$removeEmpty[w.nodeName.toLowerCase()]) {
                      q = null;
                      break
                    }
                    q && (C = !!M.length)
    ...
    a.prototype = {
      getNextParagraph: function (a) {
        ...
        if (!this._.started) {
          ...
          k = x.startPath();
          var p = x.endPath(), J = !x.collapsed && c(x, k.block), u = !x.collapsed && c(x, p.block, 1);
  ...
  (function () {
    function a(a, b, c, d, f) {
      ...
      for (e in b) {
        ...
        for (p in P) {
          l[p] = k(l[p], n) || null;
          var h = l, q = O[p], t = k(l[O[p]], n), w = l[p], B = [], g = !0, H = void 0;
          t ? g = !1 : t = {};
    ...
    function A(a, b, f, e) {
      ...
      if (e.doCallbacks && a.elementCallbacks) {
        a:{
          ...
          for (var h = 0, t = n.length, w; h < t; ++h) if (w = n[h](b)) {
            n = w;
            break a
          }
          n = void 0
      ...
      if (e.doFilter) {
        a:{
          ...
          if (a || n) {
            y(b);
            if (h) for (k = 0, g = h.length; k < g; ++k) if (!1 === c(h[k], b, E)) {
              a = null;
              break a
            }
        ...
        w = b.classBackup;
        var L = b.styleBackup, G, N, C = [], E = [], O = /^data-cke-/;
        k = !1;
        delete h.style;
        delete h["class"];
    ...
    var t = CKEDITOR.dtd, E = CKEDITOR.tools.copy, w = CKEDITOR.tools.trim, H = ["", "p", "br", "div"];
      ...
      allow: function (b, c, d) {
        ...
        a.forEach(function (a) {
          if (a.type == CKEDITOR.NODE_ELEMENT) {
            ...
            if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (n = A(f, a, e, q), n & 1) h = !0; else if (n & 2) return !1
            ...
            a:{
              ...
              1 == d.children.length && (l = d.children[0]).type == CKEDITOR.NODE_ELEMENT && A(f, l, c, q);
              c = !c.length
            }
            c || e.push(a)
          }
        ...
        for (; w = a.pop();) if (c = w.el, c.parent) switch (E = t[c.parent.name] || t.span, w.check) {
          case "it":
      ...
      var h = {}, k = function (b) {
        a.call(this, b, function (a) {
          ...
          for (e in a) {
            ...
            if (y) for (y.split && (y = y.split(",")), g = 0; g < y.length; g++) h[y[g]] || b.push(y[g])
          }
  ...
  (function () {
    ...
    function z(a) {
      ...
      CKEDITOR.plugins.load(c.split(","), function (c) {
        ...
        for (var l in c) {
          ...
          if (g && (n = g.match(h))) for (; g = n.pop();) CKEDITOR.error("editor-plugin-required", {
            plugin: g.replace(",", ""),
            requiredBy: l
          });
        ...
        CKEDITOR.scriptLoader.load(e, function () {
          for (var c = ["beforeInit", "init", "afterInit"], e = 0; e < c.length; e++) for (var l = 0; l < d.length; l++) {
            var n = d[l];
    ...
    function A(a, b) {
      ...
      for (var f = new CKEDITOR.dom.documentFragment, e, h, k, g = 0; g < a.length; g++) {
        var M = a[g], t = M.startContainer.getAscendant("tr", !0);
    ...
    CKEDITOR.htmlParser.fragment.fromHtml =
      function (h, k, g) {
        ...
        var D = new CKEDITOR.htmlParser,
          ...
          p = [], J = [], u = x, K = "textarea" == x.name, l = "pre" == x.name;
          ...
          if (a(e)) p.push(e); else {
            ...
            if ("br" == f) J.push(e); else {
              for (; !(k = (h = u.name) ? CKEDITOR.dtd[h] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, e.isUnknown || u.isUnknown || k[f]);) if (u.isOptionalClose) D.onTagClose(h); else if (f in b && h in b) h = u.children, (h = h[h.length - 1]) && "li" == h.name || z(h = new CKEDITOR.htmlParser.element("li"), u), !e.returnPoint && (e.returnPoint = u), u = h; else if (f in CKEDITOR.dtd.$listItem &&
                !A(f, h)) D.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1); else if (h in d && !A(f, h)) !e.returnPoint && (e.returnPoint = u), u = u.parent; else if (h in CKEDITOR.dtd.$inline && p.unshift(u), u.parent) z(u, u.parent, 1); else {
                e.isOrphan = 1;
                break
              }
              m(f);
    ...
    a.prototype = {
      add: function (a, c, d) {
        ...
        var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
          h = Array.prototype.slice.call(arguments, 1), k = this.rules, g = k.length, m, r, e, z;
        for (z = 0; z < g; z++) if (d && (m = c.type, r = c.name), e = k[z], !(a.nonEditable && !e.options.applyToAll ||
  ...
  (function () {
    function a(a, d) {
      ...
      function n(a, d) {
        return function (f) {
          if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            var l = [], v = b(f), n, w;
            if (v) for (t(v, 1) && l.push(v); v;) h(v) && (n = c(v)) && t(n) && ((w = c(n)) && !h(w) ? l.push(n) : (e(E).insertAfter(n), n.remove())), v = v.previous;
      ...
      var w = {elements: {}}, E = "html" == d, g = CKEDITOR.tools.extend({}, l), q;
    ...
    CKEDITOR.htmlDataProcessor = function (b) {
      ...
      b.on("toHtml", function (a) {
        a = a.data;
        var c = a.dataValue, f, c = x(c, b), c = e(c, H), c = r(c), c = e(c, w), c = c.replace(O, "$1cke:$2"),
    ...
    var M = /<(a|area|img|input|source)\b([^>]*)>/gi, t = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi,
      E = /^(href|src|name)$/i, w = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
  ...
  (function () {
    ...
    CKEDITOR.editable = CKEDITOR.tools.createClass({
      base: CKEDITOR.dom.element, $: function (a, b) {
        ...
        focus: function () {
          ...
          var t, E;
          if (f) for (; (t = b.getCommonAncestor(0, 1)) && (E = CKEDITOR.dtd[t.getName()]) && (!E || !E[e]);) t.getName() in CKEDITOR.dtd.span ? b.splitElement(t) : b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(t), b.collapse(!0), t.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ?
            "div" : "p", c.editable());
          b.insertNode(a);
          return !0
          ...
          if (!this.is("textarea")) {
            ...
            this.attachListener(a, "key", function (b) {
              ...
              if (0 !== b.getRanges().length) {
                if (c in
                  t) {
                  var f, g = b.getRanges()[0], n = g.startPath(), k, v, B, c = 8 == c;
    ...
    x = function () {
      ...
      function b(c, d) {
        var e, f, t, h, g = [], w = d.range.startContainer;
        e = d.range.startPath();
        ...
        "br" != t || !e.data("cke-eol") || k && k != p - 1 || (P = (f = k ? g[k - 1].node : H.getItem(k + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && E.$block[f.getName()]), -1 != m || h || (m = k), h || (r = k), g.push({
          ...
          name: t,
          allowed: h
        }), f = P = 0)) : g.push({isElement: 0, node: e, allowed: 1});
      ...
      function d(b, c) {
        var e = [], f = b.getChildren(), t = f.count(), h, g = 0, k = E[c], w = !b.is(E.$inline) || b.is("br");
      ...
      return function (w, n, N, v) {
        ...
        if (!v.checkReadOnly()) {
          ...
          if (!n.collapsed) {
            var B = I.block || I.blockLimit, y = n.getCommonAncestor();
          ...
          if (m = N) {
            ...
            if ((x = m.startPath().block) && (1 != x.getChildCount() || !x.getBogus())) a:{
              ...
              if (1 ==
                ...
                m = 0;
                for (v = x.count(); m < v; m++) if (n = x.getItem(m), !n.is(p)) break a;
          ...
          if (m) {
            ...
            var J, K;
            n = z.startContainer;
            var G = w.endPath.elements[0], W, I = G.getPosition(n),
            ...
            for (t(n, z); v < n.length; v++) {
              ...
              if (u) N = 0 < v; else {
                ...
                if (B && I.isElement) {
                  ...
                  if (u) J && (K = z.splitElement(J), w.zombies.push(K), w.zombies.push(J)); else {
                    J = r.getName();
                    W = !v;
                    u = v == n.length - 1;
                    J = d(I.node, J);
      ...
      return {
        list: {
          detectMerge: function (a, b) {
            var d = c(b, a.bookmark), e = d.startPath(), f = d.endPath(), w = e.contains(CKEDITOR.dtd.$list),
            ...
            if (a.mergeListBookmark) {
              var d = a.mergeListBookmark.startNode, e = a.mergeListBookmark.endNode,
                f = new CKEDITOR.dom.elementPath(d, c), w = new CKEDITOR.dom.elementPath(e, c);
              if (a.mergeList) {
                var g = f.contains(CKEDITOR.dtd.$list), h = w.contains(CKEDITOR.dtd.$list);
  ...
  (function () {
    ...
    var p = "function" != typeof window.getSelection, J = 1, u = CKEDITOR.tools.repeat("​", 7),
      K = new RegExp(u + "( )?", "g"), l, q, F, L = CKEDITOR.dom.walker.invisible(1), C = function () {
        function a(b) {
          return function (a) {
  ...
  (function () {
    ...
    function b(c) {
      ...
      if (c.collapsed) e = J(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
        ...
        c.trim();
        var r = c.createBookmark(), t = r.startNode, y = r.endNode, q = t, u;
        if (!l) {
          var x = c.getCommonAncestor(), l = a(t, x), x = a(y, x);
          l && (q = l.getNextSourceNode(!0));
          x && (y = x)
        }
        for (q.getPosition(y) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q;) {
          l = !1;
          if (q.equals(y)) q = null, l = !0; else {
            ...
            if (x && m && CKEDITOR.dtd.$block[z]) for (var E = q, C = f(E), F = void 0, H = C.length, K = 0, E = H && new CKEDITOR.dom.range(E.getDocument()); K < H; ++K) {
            ...
            if (C) if (F = q.getParent(), C = h, H = g, K = k, !F || !(F.getDtd() || CKEDITOR.dtd.span)[H] && !K || C.parentRule && !C.parentRule(F)) l = !0; else {
              if (u ||
                ...
                for (var z = q, M; (l = !z.getNext(w)) && (M = z.getParent(), p[M.getName()]) && d(M, t, h, O);) z = M;
                u.setEndAfter(z)
              }
            } else l = !0;
    ...
    var C = {
        ...
        audio: 1,
        video: 1
      }, t = /\s*(?:;\s*|$)/, E = /#\((.+?)\)/g, w = CKEDITOR.dom.walker.bookmark(0, 1),
  ...
  (function () {
    ...
    CKEDITOR.plugins.clipboard = {
      ...
      isDropRangeAffectedByDragRange: function (a, b) {
        var c =
          b.startContainer, d = b.endOffset;
      ...
      getRangeAtDropPosition: function (a, b) {
        var c =
          a.data.$, d = c.clientX, g = c.clientY, h = b.getSelection(!0).getRanges()[0], e = b.createRange();
    ...
    CKEDITOR.plugins.clipboard.fallbackDataTransfer.prototype = {
      isRequired: function () {
        ...
        if (null ===
          a._isCustomMimeTypeSupported) if (b) {
